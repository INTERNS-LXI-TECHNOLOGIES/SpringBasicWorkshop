...
*/
    ...
    public void saveContact(Contact contact) {
        try
        {
            ps = con.prepareStatement("insert into contacts(name,number,email) values('"+contact.getName()+"','"+contact.getNumber()+"','"+contact.getEmail()+"')");
            row = ps.executeUpdate();
            ps.close();
            con.close();
        }
    ...
    public void deleteContactById(int sno) {
        try
        {
            String sql = "delete from contacts where sno ='"+sno+"'";
            stmt = con.createStatement();
            stmt.executeUpdate(sql);
    ...
    public Contact getContactById(int sno) throws SQLException {
        ...
        stmt = con.createStatement();
        rs = stmt.executeQuery("select * from contacts where sno = '"+sno+"'");
        if (rs != null){
            while (rs.next()){
                edit = new Contact();
